  ...
  return (
    <div className="space-y-4 rounded-lg border border-slate-100 bg-white p-4">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-slate-800">Mülakat Geri Bildirim Raporu</h3>
      ...
      {feedback.improvements.length > 0 && (
        <div className="space-y-2">
          <p className="text-xs font-medium text-slate-500">Geliştirilmesi Gerekenler</p>
          <ul className="space-y-2">
