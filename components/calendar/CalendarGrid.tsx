          ...
          return (
            <div
              ...
              className={`min-h-[64px] rounded-lg border p-1 text-xs ${
                day === null ? 'border-transparent' : isToday ? 'border-purple-300 bg-purple-50' : 'border-slate-100 bg-white'
              }`}
            >
              {day !== null && (
                <>
                  ...
                  <div className="space-y-0.5">
                    {events.map((a) => (
                      <Link
                        ...
                        className="block truncate rounded bg-purple-100 px-1 py-0.5 text-[10px] font-medium text-purple-700 hover:bg-purple-200"
